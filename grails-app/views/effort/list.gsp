            ...
            $('#calendar').fullCalendar({
                ...
                eventRender: function (calEvent, element) {
                    var tipContent = "<strong>" + calEvent.assignmentList + "</strong><br/>" +
                            calEvent.currentDate + " - " + calEvent.timeSpent +
                            "<br/>" + "<blockquote>" +
                            calEvent.comment + "</blockquote>";
                    $(element).qtip({
                        content: tipContent,
                        position: {
                            corner: {
...
<body>
<div class="body">
    <g:select name="userId" from="${users}" optionKey="id" optionValue="name" value="${userId}" onchange="reload()"/>
    <div id="calendar"></div>
</div>
</body>
</html>
