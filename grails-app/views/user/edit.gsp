...
<div class="body">
    ...
    <g:form method="post">
        <g:hiddenField name="id" g:if value="${userInstance?.id}"/>
        ...
        <div class="dialog">
            <table>
                ...
                <tr class="prop even">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'name', 'errors')}">
                        <g:textField name="name" maxlength="25"
                                     value="${fieldValue(bean: userInstance, field: 'name')}"/>
                ...
                <sec:ifAnyGranted roles="ROLE_PROJECT_LEADER,ROLE_COMPANY_ADMIN">
                    <tr class="prop odd">
                        <td valign="top" class="name">
                            <label for="dailyWorkingHours"><g:message code="user.daily.working.hours"
                                                                      default="Daily Working Hours"/>:</label>
                        </td>
                        <td valign="top"
                            class="value ${hasErrors(bean: userInstance, field: 'dailyWorkingHours', 'errors')}">
                            <g:textField name="dailyWorkingHours" maxlength="2"
                                         value="${fieldValue(bean: userInstance, field: 'dailyWorkingHours')}"/>
                        </td>
                    </tr>
                    ...
                    <tr class="prop even">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'skills', 'errors')}">
                            <g:select name="skills" from="${skills}" optionKey="id" value="${userInstance.skills*.id}"
                                      multiple="true"/>
                        </td>
                    </tr>
                </sec:ifAnyGranted>
