...
<div class="body">
    ...
    <g:form action="save" method="post">
        <div class="dialog">
            <table>
                ...
                <tr class="prop even">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: assignmentInstance, field: 'project', 'errors')}">
                        <g:select name="project.id" from="${projectList}" optionKey="id"
                                  value="${assignmentInstance?.project?.id}"/>
                ...
                <tr class="prop even">
                    <td valign="top" class="name">
                        <label for="role">
                            <g:message code="assignment.role" default="Role"/>:
                        </label>
                    </td>
                    <td valign="top" class="value ${hasErrors(bean: assignmentInstance, field: 'role', 'errors')}">
                        <g:select name="role.id" from="${roleList}"
                                  optionKey="id"
                                  optionValue="name"/>
                ...
                <tr class="prop odd">
                    <td valign="top" class="name">
                        <label for="description"><g:message code="assignment.description"
                                                            default="Description"/>:</label>
                    </td>
                    <td valign="top"
                        class="value ${hasErrors(bean: assignmentInstance, field: 'description', 'errors')}">
                        <g:textArea name="description" rows="5" cols="40"
                                    value="${fieldValue(bean: assignmentInstance, field: 'description')}"/>
        ...
        <div class="buttons">
            <span class="menuButton"><g:link class="list" action="list"><g:message code="assignment.list"
                                                                                   default="Assignment List"/></g:link></span>
