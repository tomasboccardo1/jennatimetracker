            ...
            <table>
                ...
                <tr class="prop odd">
                    ...
                    <td valign="top" class="value"><g:link controller="project" action="show"
                                                           id="${assignmentInstance?.project?.id}">${assignmentInstance?.project?.encodeAsHTML()}</g:link></td>
                ...
                <tr class="prop odd">
                    ...
                    <td valign="top" class="value"><g:link controller="role" action="show"
                                                           id="${assignmentInstance?.role?.id}">${assignmentInstance?.role?.encodeAsHTML()}</g:link></td>
                </tr>
        ...
        <div class="buttons">
            <span class="menuButton">
                <g:link class="list" action="list">
                    <g:message code="assignment.list" default="Assignment List"/>
                </g:link>
            </span>
            <span class="menuButton">
                <g:link class="create" action="create">
                    <g:message code="assignment.new" default="New Assignment"/>
                </g:link></span>
            <span class="button">
                <g:actionSubmit class="edit" action="edit"
                                value="${message(code: 'edit', 'default': 'Edit')}"/>
            </span>
            <span class="button">
